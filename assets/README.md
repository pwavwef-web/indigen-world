...
Approved shared visual assets belong here.
...
- Move superseded assets to `legacy` rather than presenting them as current.
- Large media and private cultural records belong in approved storage, not Git.
