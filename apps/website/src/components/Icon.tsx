 ...
 *
 * A small inline-SVG icon set, carried over unchanged from the
 * uploaded template. Kept as one switch-based component (rather than
 * one file per icon) because every icon shares the same stroke-based
 * style and prop shape — splitting them into a dozen tiny files would
