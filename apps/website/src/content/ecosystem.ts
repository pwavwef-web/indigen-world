...
export const ECOSYSTEM_PRODUCTS: EcosystemProduct[] = [
  ...
  },
  {
    ...
    body: "The founding-creator waitlist is open now — register for Project Kasena's Kasem-language campaigns, build your profile, and be first when submissions open. The wider creator and validator workspace is still in development.",
