...
/// the credit line simply leaves the name out rather than writing "by ".
 String get tatoebaContributor; String get sentenceLicence; String get attribution; String? get culturalNote; String get authenticationStatus; String get literalTranslation; String get usageContext; String get frenchTranslation;/// A published recording of the headword being said, or empty where the
/// entry has none.
///
...
@EntrySenseListConverter() List<EntrySense> get senses;/// Whether this entry is in the dictionary.
///
...
/// field existed was, by construction, holding a published one.
 bool get isPublished;/// The entry this one was folded into, or empty.
///
...
as String?,authenticationStatus: null == authenticationStatus ? _self.authenticationStatus : authenticationStatus // ignore: cast_nullable_to_non_nullable
as String,literalTranslation: null == literalTranslation ? _self.literalTranslation : literalTranslation // ignore: cast_nullable_to_non_nullable
as String,usageContext: null == usageContext ? _self.usageContext : usageContext // ignore: cast_nullable_to_non_nullable
as String,frenchTranslation: null == frenchTranslation ? _self.frenchTranslation : frenchTranslation // ignore: cast_nullable_to_non_nullable
...
as List<EntrySense>,isPublished: null == isPublished ? _self.isPublished : isPublished // ignore: cast_nullable_to_non_nullable
as bool,mergedIntoId: null == mergedIntoId ? _self.mergedIntoId : mergedIntoId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String headword,  String translation,  List<String> translations,  List<String> renderings,  String partOfSpeech,  String dialect,  String pronunciation,  String example,  String exampleTranslation,  String sentenceSource,  String tatoebaId,  String tatoebaContributor,  String sentenceLicence,  String attribution,  String? culturalNote,  String authenticationStatus,  String literalTranslation,  String usageContext,  String frenchTranslation,  String audioUrl,  String definiteForm,  String pluralForm,  String pluralDefiniteForm,  String countedForm,  String pronounForm,  String definiteArticle,  String numeralSeries,  String numeralPrefix,  String presentForm,  String pastForm,  String futureForm,  String pluralSubjectForm,  String imperativeForm,  String agreeingOneForm,  String agreeingTwoForm,  List<String> alsoUsedAs,  String ipa,  String kasemDefinition,  String etymology,  String nounClass,  int homographIndex, @EntrySenseListConverter()  List<EntrySense> senses,  bool isPublished,  String mergedIntoId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DictionaryEntry() when $default != null:
return $default(_that.id,_that.headword,_that.translation,_that.translations,_that.renderings,_that.partOfSpeech,_that.dialect,_that.pronunciation,_that.example,_that.exampleTranslation,_that.sentenceSource,_that.tatoebaId,_that.tatoebaContributor,_that.sentenceLicence,_that.attribution,_that.culturalNote,_that.authenticationStatus,_that.literalTranslation,_that.usageContext,_that.frenchTranslation,_that.audioUrl,_that.definiteForm,_that.pluralForm,_that.pluralDefiniteForm,_that.countedForm,_that.pronounForm,_that.definiteArticle,_that.numeralSeries,_that.numeralPrefix,_that.presentForm,_that.pastForm,_that.futureForm,_that.pluralSubjectForm,_that.imperativeForm,_that.agreeingOneForm,_that.agreeingTwoForm,_that.alsoUsedAs,_that.ipa,_that.kasemDefinition,_that.etymology,_that.nounClass,_that.homographIndex,_that.senses,_that.isPublished,_that.mergedIntoId);case _:
  return orElse();
...
@override@JsonKey() final  String authenticationStatus;
@override@JsonKey() final  String literalTranslation;
@override@JsonKey() final  String usageContext;
@override@JsonKey() final  String frenchTranslation;
...
/// became rather than shown a missing page — which is the whole reason
/// merging retires the duplicate instead of deleting it.
@override@JsonKey() final  String mergedIntoId;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DictionaryEntry&&(identical(other.id, id) || other.id == id)&&(identical(other.headword, headword) || other.headword == headword)&&(identical(other.translation, translation) || other.translation == translation)&&const DeepCollectionEquality().equals(other._translations, _translations)&&const DeepCollectionEquality().equals(other._renderings, _renderings)&&(identical(other.partOfSpeech, partOfSpeech) || other.partOfSpeech == partOfSpeech)&&(identical(other.dialect, dialect) || other.dialect == dialect)&&(identical(other.pronunciation, pronunciation) || other.pronunciation == pronunciation)&&(identical(other.example, example) || other.example == example)&&(identical(other.exampleTranslation, exampleTranslation) || other.exampleTranslation == exampleTranslation)&&(identical(other.sentenceSource, sentenceSource) || other.sentenceSource == sentenceSource)&&(identical(other.tatoebaId, tatoebaId) || other.tatoebaId == tatoebaId)&&(identical(other.tatoebaContributor, tatoebaContributor) || other.tatoebaContributor == tatoebaContributor)&&(identical(other.sentenceLicence, sentenceLicence) || other.sentenceLicence == sentenceLicence)&&(identical(other.attribution, attribution) || other.attribution == attribution)&&(identical(other.culturalNote, culturalNote) || other.culturalNote == culturalNote)&&(identical(other.authenticationStatus, authenticationStatus) || other.authenticationStatus == authenticationStatus)&&(identical(other.literalTranslation, literalTranslation) || other.literalTranslation == literalTranslation)&&(identical(other.usageContext, usageContext) || other.usageContext == usageContext)&&(identical(other.frenchTranslation, frenchTranslation) || other.frenchTranslation == frenchTranslation)&&(identical(other.audioUrl, audioUrl) || other.audioUrl == audioUrl)&&(identical(other.definiteForm, definiteForm) || other.definiteForm == definiteForm)&&(identical(other.pluralForm, pluralForm) || other.pluralForm == pluralForm)&&(identical(other.pluralDefiniteForm, pluralDefiniteForm) || other.pluralDefiniteForm == pluralDefiniteForm)&&(identical(other.countedForm, countedForm) || other.countedForm == countedForm)&&(identical(other.pronounForm, pronounForm) || other.pronounForm == pronounForm)&&(identical(other.definiteArticle, definiteArticle) || other.definiteArticle == definiteArticle)&&(identical(other.numeralSeries, numeralSeries) || other.numeralSeries == numeralSeries)&&(identical(other.numeralPrefix, numeralPrefix) || other.numeralPrefix == numeralPrefix)&&(identical(other.presentForm, presentForm) || other.presentForm == presentForm)&&(identical(other.pastForm, pastForm) || other.pastForm == pastForm)&&(identical(other.futureForm, futureForm) || other.futureForm == futureForm)&&(identical(other.pluralSubjectForm, pluralSubjectForm) || other.pluralSubjectForm == pluralSubjectForm)&&(identical(other.imperativeForm, imperativeForm) || other.imperativeForm == imperativeForm)&&(identical(other.agreeingOneForm, agreeingOneForm) || other.agreeingOneForm == agreeingOneForm)&&(identical(other.agreeingTwoForm, agreeingTwoForm) || other.agreeingTwoForm == agreeingTwoForm)&&const DeepCollectionEquality().equals(other._alsoUsedAs, _alsoUsedAs)&&(identical(other.ipa, ipa) || other.ipa == ipa)&&(identical(other.kasemDefinition, kasemDefinition) || other.kasemDefinition == kasemDefinition)&&(identical(other.etymology, etymology) || other.etymology == etymology)&&(identical(other.nounClass, nounClass) || other.nounClass == nounClass)&&(identical(other.homographIndex, homographIndex) || other.homographIndex == homographIndex)&&const DeepCollectionEquality().equals(other._senses, _senses)&&(identical(other.isPublished, isPublished) || other.isPublished == isPublished)&&(identical(other.mergedIntoId, mergedIntoId) || other.mergedIntoId == mergedIntoId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,headword,translation,const DeepCollectionEquality().hash(_translations),const DeepCollectionEquality().hash(_renderings),partOfSpeech,dialect,pronunciation,example,exampleTranslation,sentenceSource,tatoebaId,tatoebaContributor,sentenceLicence,attribution,culturalNote,authenticationStatus,literalTranslation,usageContext,frenchTranslation,audioUrl,definiteForm,pluralForm,pluralDefiniteForm,countedForm,pronounForm,definiteArticle,numeralSeries,numeralPrefix,presentForm,pastForm,futureForm,pluralSubjectForm,imperativeForm,agreeingOneForm,agreeingTwoForm,const DeepCollectionEquality().hash(_alsoUsedAs),ipa,kasemDefinition,etymology,nounClass,homographIndex,const DeepCollectionEquality().hash(_senses),isPublished,mergedIntoId]);
