...
//
//   node apps/updates-blog/posts/2026-09-16-beyond-the-reef/mockups/render.mjs
//
// Each page is plain HTML that frames real captures of the live page from
// ../screens (made by capture.mjs) in a laptop, browser windows and phones. Chrome is driven over the DevTools protocol rather than with
...
const jobs = [
  ...
  { page: 'journey.html', out: '../images/journey.jpg', width: 1600, height: 900 },
  { page: 'phone.html', out: '../images/on-a-phone.jpg', width: 1600, height: 1150 },
];
