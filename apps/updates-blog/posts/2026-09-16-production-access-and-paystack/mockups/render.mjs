...
//
// Each page is plain HTML in the Updates blog palette. Chrome is driven over the DevTools protocol rather than with
...
const jobs = [
  ...
  { page: 'checklist.html', out: '../images/road-to-launch.png', width: 1600, height: 960, format: 'png' },
];
