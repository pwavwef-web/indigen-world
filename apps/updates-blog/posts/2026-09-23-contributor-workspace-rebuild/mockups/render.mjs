...
//
//   node apps/updates-blog/posts/2026-09-23-contributor-workspace-rebuild/mockups/render.mjs
//
// Run capture.mjs first for the screens. Each page is plain HTML in the Updates blog palette. Chrome is driven over the DevTools protocol rather than with
// `--screenshot`, so each page can say when its fonts are ready.
...
const jobs = [
  ...
  { page: 'workspace.html', out: '../images/workspace-overview.jpg', width: 1600, height: 1100 },
  { page: 'phones.html', out: '../images/on-a-phone.jpg', width: 1600, height: 1150 },
  { page: 'kawuri.html', out: '../images/kawuri-intelligence.jpg', width: 1600, height: 1130 },
  { page: 'payments.html', out: '../images/payment-details.jpg', width: 1600, height: 1180 },
];

const browser = spawn(chrome, [
  '--headless=new',
  `--remote-debugging-port=${port}`,
  `--user-data-dir=${mkdtempSync(join(tmpdir(), 'iw-workspace-mockups-'))}`,
  '--hide-scrollbars',
